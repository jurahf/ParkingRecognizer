...
namespace Yolov7net.test
{
    public class Yolov7Test
    {
        ...
        {
            using var yolo = new Yolov7tiny("./assets/yolov7-tiny.onnx", false);
        ...
        {
            using var yolo = new Yolov5("./assets/yolov5-tiny_640x640.onnx");
        ...
        {
            using var yolo = new Yolov8("./assets/yolov8n.onnx", useCuda: false);
